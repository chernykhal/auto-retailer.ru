<template>
    <jet-form-section @submitted="updateContract">
        <template #title>
            Изменить информацию контракта
        </template>
...
export default {
    ...
    props: ['carsList', 'usersList', 'customersList','contract'],
    ...
    methods: {
        updateContract() {
            this.form.put(route('contracts.update', this.contract), {
                preserveScroll: true
            })
        },
    },
