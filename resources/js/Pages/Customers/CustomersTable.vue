                            ...
                            <div class="table-row-group">
                                <div v-for="customer in customers" :key="customer.id" class="table-row">
                                    ...
                                    <div class="table-cell px-4 py-2 text-right">
                                        ...
                                        <jet-secondary-button @click.native="confirmCustomerDeletion(customer)"
                                        ...
                                        <jet-dialog-modal :show="confirmingCustomerDeletion"
                                            ...
                                            <template #content>
                                                ...
                                                <div class="mt-4">
                                                    <jet-input type="password" class="mt-1 block w-3/4"
                                                               ...
                                                               @keyup.enter.native="deleteCustomer"/>
                                            ...
                                            <template #footer>
                                                <jet-secondary-button
                                                    @click.native="confirmingCustomerDeletion = false">
                                                    Отмена
                                                </jet-secondary-button>

                                                <jet-danger-button class="ml-2" @click.native="deleteCustomer"
...
export default {
    ...
    methods: {
        ...
        deleteCustomer() {
            this.deleteForm.post(route('customers.destroy', this.customer), {
                preserveScroll: true
            }).then(response => {
