            ...
            <jet-search-section @submitted="search">
                <template #form>
                    <div class="flex items-center py-2">
                        ...
                        <inertia-link class="flex-shrink-0 border-transparent border-4 text-teal-500 hover:text-teal-800 text-sm py-1 px-2 rounded" :href="route('cars.index')" title="Сбросить">
