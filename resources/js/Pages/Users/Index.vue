            ...
            <jet-search-section @submitted="search">
                <template #form>
                    <div class="flex items-center py-2">
                        <a :href="route('users.export')" title="Печать"
...
<!--                        <inertia-link :href="route('register')" title="Создать" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150 bg-white ">-->
...
<!--                        </inertia-link>-->
                        ...
                        <inertia-link class="flex-shrink-0 border-transparent border-4 text-teal-500 hover:text-teal-800 text-sm py-1 px-2 rounded" :href="route('users.index')" title="Сбросить">
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <jet-users-table :users="$page.users"/>
        </div>
    </app-layout>
</template>
...
import JetUsersTable from "./UsersTable";
